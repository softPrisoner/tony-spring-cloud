...
<link href="<%=path%>/system/layout_modern/skin/style.css" rel="stylesheet" type="text/css" id="skin"  skinPath="system/layout_modern/skin/"/>
	...
	<div id="bs_navright">
		<div class="bs_nav">
			...
			<div class="float_right padding_top2 padding_right5">
				...
				<span class="icon_fullscreen hand" id="fullSrceen" hideNav="true">全屏</span>
				<span class="icon_lock hand" onclick="lockScreen()">锁屏</span>
				<span class="icon_exit hand" onclick='top.Dialog.confirm("确定要退出系统吗",function(){window.location="<%=path%>/system/login/login_modern.html"});'>退出</span>
			</div>
			<div class="clear"></div>
		</div>
	</div>
   		...
   		<div class="ali01 ver01"  width="100%">
			<div id="rbox">
				...
				<div id="rbox_middleright">
					<div id="bs_right">
					       <IFRAME height="100%" width="100%" frameBorder=0 id=frmright name=frmright src="<%=path%>/system/layout_modern/open.jsp"  allowTransparency="true"></IFRAME>
					</div>
				</div>
				</div>
				</div>
